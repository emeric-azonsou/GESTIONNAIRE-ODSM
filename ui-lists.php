    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Lists')); ?>
                                    ...
                                    <div>
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><i
                                                    class="ri-file-copy-2-line align-middle me-2"></i>Send over all the
                                                documentation.</li>
                                            <li class="list-group-item"><i
                                                    class="ri-question-answer-line align-middle me-2"></i>Meeting with
                                                daron to review the intake form</li>
                                            <li class="list-group-item"><i
                                                    class="ri-secure-payment-line align-middle me-2"></i>Check uikings
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group list-group-fill-success">
                                        ...
                                        <a href="#" class="list-group-item list-group-item-action"><i
                                                class="ri-notification-3-line align-middle me-2"></i>Push
                                            Notification</a>
                                        <a href="#" class="list-group-item list-group-item-action disabled"
                                            tabindex="-1"><i class="ri-moon-fill align-middle me-2"></i>Dark Mode</a>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        <button type="button" class="list-group-item list-group-item-action active"
                                            aria-current="true"><i
                                                class="ri-reply-fill align-middle me-2"></i>Reply</button>
                                        <button type="button" class="list-group-item list-group-item-action"><i
                                                class="ri-share-forward-fill align-middle me-2"></i>Forward
                                            Message</button>
                                        <button type="button" class="list-group-item list-group-item-action"><i
                                                class="ri-equalizer-line align-middle me-2"></i>Filter Message</button>
                                        <button type="button" class="list-group-item list-group-item-action"><i
                                                class="ri-delete-bin-5-line align-middle me-2"></i>Delete
                                            Message</button>
                                        <button type="button" class="list-group-item list-group-item-action" disabled><i
                                                class="ri-forbid-line align-middle me-2"></i>Block "Mark
                                            Spencer</button>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <div class="list-group">
                                            ...
                                            <a href="#"
                                                class="list-group-item list-group-item-action list-group-item-light text-body">A
                                                simple light list group item</a>
                                            <a href="#"
                                                class="list-group-item list-group-item-action list-group-item-dark text-body">A
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Add nearly any HTML within, even for linked list groups like
                                        the one below, with the help of <a
                                            href="https://getbootstrap.com/docs/5.1/utilities/flex/">flexbox
                                            utilities</a>.</p>
                                    <div class="list-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use badges to any list group item to show unread counts,
                                        activity, and more with the help of some <a
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        <label class="list-group-item">
                                            <input class="form-check-input fs-md mt-0 align-middle me-1"
                                                name="exampleRadios" type="radio" value="">
                                            Declined Payment
                                        </label>
                                        <label class="list-group-item">
                                            <input class="form-check-input fs-md mt-0 align-middle me-1"
                                                name="exampleRadios" type="radio" value="" checked>
                                            Delivery Error
                                        </label>
                                        <label class="list-group-item">
                                            <input class="form-check-input fs-md mt-0 align-middle me-1"
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item"><i
                                                class="ti ti-checkbox align-middle lh-1 me-2"></i> Send the billing
                                            agreement</li>
                                        <li class="list-group-item"><i
                                                class="ti ti-checkbox align-middle lh-1 me-2"></i> Send over all the
                                            documentation.</li>
                                        <li class="list-group-item"><i
                                                class="ti ti-checkbox align-middle lh-1 me-2"></i> Meeting with
                                            daron to review the intake form</li>
                                        <li class="list-group-item"><i
                                                class="ti ti-checkbox align-middle lh-1 me-2"></i> Check uikings
                                            theme and give customer support</li>
                                        <li class="list-group-item"><i
                                                class="ti ti-checkbox align-middle lh-1 me-2"></i> Start making a
                                            presentation</li>
                                    </ul>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
