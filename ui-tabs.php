    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Tabs')); ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-justified mb-3" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#base-justified-home"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab"
                                                href="#base-justified-product" role="tab" aria-selected="false">
                                                Product
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#base-justified-settings"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills nav-success mb-3" role="tablist">
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link" data-bs-toggle="tab" href="#messages-1"
                                                role="tab">Messages</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link" data-bs-toggle="tab" href="#settings-1"
                                                role="tab">Settings</a>
                                        </li>
                                    </ul>
                                    <!-- Tab panes -->
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-sm btn-subtle-primary">Read More <i
                                    ...
                                    <div class="tab-content text-muted">
                                        <div class="tab-pane active" id="arrow-overview" role="tabpanel">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                hours to create a <a href="javascript:void(0);"
                                                    class="text-decoration-underline"><b>Fantastic Design</b></a> by
                                        ...
                                        <div class="tab-pane" id="arrow-profile" role="tabpanel">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                interested in the unusual, and that’s why using contrasting colors in <a
                                                    href="javascript:void(0);"
                                                    class="text-decoration-underline"><b>Graphic Design</b></a> is a
                                        ...
                                        <div class="tab-pane" id="arrow-contact" role="tabpanel">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                excellent news to the beginner and advanced <a
                                                    href="javascript:void(0);"
                                ...
                                <div class="card-header align-items-xl-center d-xl-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <ul class="nav nav-pills card-header-pills" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#developers"
                                                    role="tab">
                                                    Developers
                                                </a>
                                            </li>
                            ...
                            <div class="card">
                                ...
                                <div class="border">
                                    <ul class="nav nav-pills custom-hover-nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a href="#custom-hover-description" data-bs-toggle="tab"
                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>$745</td>
                                                            <td>4.4 <i
                                                                    class="ri-star-s-fill ms-1 text-warning align-middle"></i>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="nav nav-pills flex-column nav-pills-tab custom-verti-nav-pills text-center"
                                                ...
                                                <a class="nav-link" id="custom-v-pills-profile-tab"
                                                    data-bs-toggle="pill" href="#custom-v-pills-profile" role="tab"
                                                ...
                                                <a class="nav-link" id="custom-v-pills-messages-tab"
                                                    data-bs-toggle="pill" href="#custom-v-pills-messages" role="tab"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-justified mb-3" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link align-middle" data-bs-toggle="tab"
                                                href="#nav-badge-profile" role="tab" aria-selected="false">
                                                Profile <span class="badge bg-success">Done</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link align-middle" data-bs-toggle="tab"
                                                href="#nav-badge-messages" role="tab" aria-selected="false">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-border-top nav-border-top-primary mb-3" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#nav-border-top-home"
                                                role="tab" aria-selected="false">
                                                Home
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#nav-border-top-profile"
                                                role="tab" aria-selected="false">
                                                Profile
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#nav-border-top-messages"
                                                role="tab" aria-selected="false">
                                                Messages
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab"
                                                href="#nav-border-top-settings" role="tab" aria-selected="true">
                                                Settings
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills nav-custom nav-custom-success mb-3" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#nav-colored-profile"
                                                role="tab">
                                                Profile
                                            </a>
                                        </li>
