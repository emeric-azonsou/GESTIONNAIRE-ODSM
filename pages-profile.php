    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Pages', 'title' => 'Profile ')); ?>
             

                    <div class="card">
                        <div class="profile-foreground position-relative">
                            <div class="profile-wid-bg position-static">
                                <img src="assets/images/small/img-3.jpg" alt="" class="profile-wid-img card-img-top">
                            </div>
                        ...
                        <div class="card-body mt-n5">
                            <div class="position-relative mt-n3">
                                <div class="avatar-lg">
                                    <img src="assets/images/users/avatar-4.jpg" alt="user-img" class="img-thumbnail rounded-circle" style="z-index: 1;">
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="">
                                    <a href="pages-profile-settings.php" class="btn btn-primary"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="py-3 border-top border-dashed">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <img src="assets/images/small/img-10.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                            <div class="col-3">
                                                <img src="assets/images/small/img-11.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                            <div class="col-3">
                                                <img src="assets/images/small/img-12.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                    </div>
