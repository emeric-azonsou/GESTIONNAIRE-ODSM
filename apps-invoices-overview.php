...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Invoice', 'title' => 'Invoice Overview')); ?>
    ...
    <!-- invoice overview -->
    <script src="assets/js/pages/invoice-overview.init.js"></script>
