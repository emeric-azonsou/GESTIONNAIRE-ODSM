...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Datatables')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Tables', 'title' => 'Datatables')); ?>
                                    ...
                                    <table id="alternative-pagination" class="table nowrap dt-responsive align-middle table-hover table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$68,789.63</td>
                                                <td>$888,411,910</td>
                                                <td><h6 class="text-success fs-sm mb-0"><i class="ti ti-trending-up align-middle me-1"></i>1.50%</h6></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>$3,588.14</td>
                                                <td>$314,520,675</td>
                                                <td><h6 class="text-danger fs-sm mb-0"><i class="ti ti-trending-down align-middle me-1"></i>0.42%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$104.33</td>
                                                <td>$314,520,675</td>
                                                <td><h6 class="text-success fs-sm mb-0"><i class="ti ti-trending-up align-middle me-1"></i>0.89%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$8691.75</td>
                                                <td>$9,847,327</td>
                                                <td><h6 class="text-success fs-sm mb-0"><i class="ti ti-trending-up align-middle me-1"></i>1.92%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$172.3</td>
                                                <td>$40,559,274</td>
                                                <td><h6 class="text-danger fs-sm mb-0"><i class="ti ti-trending-down align-middle me-1"></i>2.87%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 class="text-success fs-sm mb-0"><i class="ti ti-trending-up align-middle me-1"></i>3.96%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><h6 class="text-danger fs-sm mb-0"><i class="ti ti-trending-down align-middle me-1"></i>0.84%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$255.01</td>
                                                <td>$156,209,195.18</td>
                                                <td><h6 class="text-success fs-sm mb-0"><i class="ti ti-trending-up align-middle me-1"></i>8.20%</h6></td>
                                                <td>
                                                    <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                                                </td>
                                            </tr>
