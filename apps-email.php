                                ...
                                <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                                    ...
                                    <div class="d-block d-lg-none">
                                        ...
                                        <div class="vstack email-chat-list mx-n4">
                                            ...
                                            <a href="javascript: void(0);" class="d-flex align-items-center active">
                                                <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                                    <img class="img-fluid rounded-circle" src="assets/images/users/avatar-6.jpg" alt="">
                                                </div>
                                            ...
                                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                                    <img class="img-fluid rounded-circle" src="assets/images/users/avatar-7.jpg" alt="">
                                                </div>
                                            ...
                                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                                    <img class="img-fluid rounded-circle" src="assets/images/users/avatar-8.jpg" alt="">
                                                </div>
                                            ...
                                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                                    <img class="img-fluid rounded-circle" src="assets/images/users/avatar-9.jpg" alt="">
                                                </div>
                        ...
                        <div class="email-content">
                            <div class="email-panel p-3 pt-4 d-none d-lg-flex align-items-center border-0">
                                <div class="panel-list d-flex gap-4">
                                    <a href="apps-email.php" class="active"><i class="fs-md bi bi-envelope"></i> <span class="fs-md">Email</span></a>
                                    <a href="apps-chat.php"><i class="fs-md bi bi-chat-dots"></i> <span class="fs-md">Chat</span></a>
                                    <a href="apps-chat.php"><i class="fs-md bi bi-camera-video"></i> <span class="fs-md">Meet</span></a>
                                    <a href="apps-file-manager.php"><i class="fs-md bi bi-database"></i> <span class="fs-md">Storage</span></a>
                                </div>
                            </div>
                            <div class="p-4 pb-0">
