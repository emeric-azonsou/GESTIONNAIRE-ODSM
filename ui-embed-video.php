...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Embed Video')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Embed Video')); ?>
