...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Wizard')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Forms', 'title' => 'Wizard')); ?>
                                ...
                                <div class="card-body form-steps">
                                    <form action="#">
                                        <a class="navbar-brand d-block text-center pt-3 pb-4 mb-1" href="#">
                                            <img src="assets/images/logo-dark.png" class="card-logo mx-auto card-logo-dark" alt="logo dark" height="22">
                                            <img src="assets/images/logo-light.png" class="card-logo mx-auto card-logo-light" alt="logo light" height="22">
                                        </a>
