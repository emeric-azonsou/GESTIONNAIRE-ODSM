...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Media Object')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Media Object')); ?>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-start text-muted mb-4">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="assets/images/users/avatar-2.jpg" class="avatar-sm rounded"
                                                    alt="...">
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-start text-muted">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="assets/images/users/avatar-4.jpg" class="avatar-sm rounded"
                                                    alt="...">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h5 class="fs-md">Media heading</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center text-muted mb-4">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="assets/images/users/avatar-6.jpg" class="avatar-sm rounded"
                                                    alt="...">
                                            </div>
                                        ...
                                        <div class="d-flex align-items-end text-muted">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="assets/images/users/avatar-8.jpg" class="avatar-sm rounded"
                                                    alt="...">
                                            </div>
                                            <div class="flex-grow-1">
