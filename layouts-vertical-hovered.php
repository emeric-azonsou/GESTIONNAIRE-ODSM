...
<?php
// Main script
$title = 'Vertical Hovered'; // Define the variable
include('partials/title-meta.php'); // Include the partial and use the variable
?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php
// Main script
$pagetitle = 'Layouts'; // Define the title variable
$title = 'Vertical Hovered'; // Define the title variable

include('partials/page-title.php'); // Include the partial and use the variables
?>
