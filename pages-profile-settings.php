...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Profile Settings Settings')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Pages', 'title' => 'Profile Settings')); ?>
                  

                    <div class="card">
                        <div class="profile-foreground position-relative">
                            <div class="profile-wid-bg position-static">
                                <img src="assets/images/small/img-2.jpg" alt="" class="profile-wid-img card-img-top">
                                <div>
                            ...
                            <div class="card">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="changePassword" role="tabpanel">
                                        ...
                                        <div class="card-body">
                                            <form action="pages-profile-settings.php">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="auth-pass-inputgroup">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="password" class="form-control  password-input fs-md" id="oldpasswordInput" placeholder="Enter current password">
