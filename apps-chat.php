                ...
                <div class="container-fluid">
                    <div class="chat-wrapper-menu p-3 d-flex rounded align-items-center">
                        <div class="me-4 position-relative d-none d-lg-block">
                            <a href="#!"><img src="assets/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded"></a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            <h5 class="text-truncate mb-1 fs-lg"><a class="text-reset username" href="#">Lisa Parker</a></h5>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        <h5 class="text-truncate mb-1 fs-lg">
                                                                            <a class="text-reset username" href="#">Lisa Parker</a>
                                                                        </h5>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        <h5 class="text-truncate mb-0 fs-lg"><a class="text-reset username" href="#">Lisa Parker</a></h5>
                            ...
                            <div class="card border-0 bg-transparent">
                                <div class="card-body">
                                    ...
                                    <div class="text-center border-bottom border-dashed pb-4">
                                        <img src="assets/images/users/avatar-1.jpg" alt="" class="avatar-lg rounded-circle p-1 img-thumbnail profile-img">
                                        <div class="mt-3">
                                            <h5 class="fs-lg username">Richard Marshall</h5>
                                            <p class="text-muted"><i class="bi bi-geo-alt-fill align-middle me-2 text-primary"></i>Depew, New York(NY), 14043</p>
                                        </div>
                                    </div>

                                    <div class="py-4">
                                        <h5 class="card-title fs-lg mb-3">About</h5>
                                        <p class="text-muted mb-0">A Web Developer creates and designs different websites for clients. They are responsible for their aesthetic as well as their function.</p>
                                    </div>
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <div>
                                            <img src="assets/images/pdf.png" alt="" class="" width="30">
                                            <img src="assets/images/new-document.png" alt="" class="" width="30">
                                        </div>
                                    </div>
                                </div>
                            </div>
