                                        ...
                                        <div class="card-body p-sm-5 m-lg-4">
                                            <div class="p-2 mt-4">
                                                <div class="text-muted text-center mb-4 pb-2 mx-lg-3">
                                                    <div class="mb-4">
                                                        <img src="assets/images/auth/permission.png" alt="" class="img-fluid auth-twostep">
                                                    </div>
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <a href="auth-pass-reset.php" class="text-secondary text-decoration-underline">Resend</a>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
                                </div>
