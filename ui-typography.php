    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Typography')); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <blockquote
                                                    class="blockquote custom-blockquote blockquote-dark text-body rounded mb-0">
