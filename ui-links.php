...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Colored links')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Colored Links')); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <p><a href="#"
                                                ...
                                                link</a></p>
                                        <p><a href="#"
                                                class="link-light  text-body link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-100-hover">Light
                                                link</a></p>
                                        <p><a href="#"
                                                class="link-dark text-body link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-100-hover">Dark
                                                link</a></p>
                                        <p><a href="#"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="hstack d-block d-md-flex gap-4">
                                        ...
                                        <a class="icon-link icon-link-hover"
                                            style="--tb-icon-link-transform: translate3d(0, -.125rem, 0);" href="#">
                                            <i class="bi bi-clipboard"></i> Icon link
                                        </a>
                                        <a class="icon-link icon-link-hover"
                                            style="--tb-link-hover-color-rgb: var(--tb-success-rgb);" href="#">
                                            Icon link <i class="bi bi-arrow-right"></i>
                                        </a>
