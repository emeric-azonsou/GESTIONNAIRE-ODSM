    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Cards')); ?>
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <button type="button" class="btn-close float-end fs-xxs"
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <button type="button" class="btn-close float-end fs-xxs"
                                                aria-label="Close"></button>
                                            <h6 class="card-title mb-0">Invoice<span
                                                    class="text-secondary">#45155468</span></h6>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <figure class="mb-0">
                                                    ...
                                                    <figcaption class="blockquote-footer fs-sm text-end mb-0">
                                                        Creative Agency<cite title="Source Title"
                                                            class="text-primary fw-semibold"> Alice Mellor</cite>
                                                    </figcaption>
                                                </figure>
                                            </blockquote>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-3"><i
                                            class="ri-user-3-fill align-middle me-1 text-muted"></i> Natasha Carey</h4>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li class="list-inline-item">
                                                    <a class="align-middle" data-toggle="reload"
                                                ...
                                                <li class="list-inline-item">
                                                    <button type="button" onclick="delthis('card-none1')"
                                                        class="btn-close fs-3xs align-middle"></button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card card-overlay">
                                        <img class="card-img img-fluid" src="assets/images/small/img-12.jpg"
                                            alt="Card image">
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card card-overlay">
                                        <img class="card-img img-fluid" src="assets/images/small/img-1.jpg"
                                            alt="Card image">
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card card-overlay">
                                        <img class="card-img img-fluid" src="assets/images/small/img-5.jpg"
                                            alt="Card image">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-footer">
                                            <div class="text-center">
                                                <a href="javascript:void(0);" class="text-white-75">Connect Now <i
                                    ...
                                    <div class="card border overflow-hidden card-border-primary">
                                        <div class="card-header">
                                            ...
                                            <h6 class="card-title mb-0">Handle to Forcast <span
                                                    class="badge bg-danger align-middle fs-3xs">Poor</span></h6>
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="card border overflow-hidden card-border-success">
                                        <div class="card-header">
                                            ...
                                            <h6 class="card-title mb-0">Quality Forcast <span
                                                    class="badge bg-success align-middle fs-3xs">Excellent</span></h6>
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="card border overflow-hidden card-border-info">
                                        <div class="card-header">
                                            <h6 class="card-title mb-0">Check your E-mails <span
                                                    class="badge bg-info align-middle fs-3xs">In Process</span></h6>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text">They all have something to say beyond the words on the
                                                page. They can come across as casual or neutral, exotic or graphic.
                            ...
                            <div class="card border overflow-hidden card-border-warning">
                                <div class="card-header">
                                    <h6 class="card-title mb-0">Check your Payment <span
                                            class="badge bg-warning align-middle fs-3xs">Pending</span></h6>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card border overflow-hidden card-border-danger">
                                <div class="card-header">
                                    <h6 class="card-title mb-0">Your Ordered Cancel <span
                                            class="badge bg-danger align-middle fs-3xs">Cancel</span></h6>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">They all have something to say beyond the words on the page.
                                        They can come across as casual or neutral, exotic or graphic. Cosby sweater eu
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xxl col-md-4">
                            <div class="card h-100">
                                <img class="card-img-top img-fluid" src="assets/images/small/img-10.jpg"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title">Give your text a good structure?</h4>
