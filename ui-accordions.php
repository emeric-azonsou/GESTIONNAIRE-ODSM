...
<head>
<?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Accordions')); ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Base UI', 'title' => 'Accordions')); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="accordion lefticon-accordion custom-accordionwithicon accordion-border-box"
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="accor_lefticonExamplecollapse1"
                                                class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="accordionborderedExample1">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    aria-expanded="true" aria-controls="accor_borderedExamplecollapse1">
                                                    What is User Interface Design?
                                                </button>
                                            </h2>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="accordionnestingExample2">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    aria-expanded="false" aria-controls="accor_nestingExamplecollapse2">
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="accordionnestingExample3">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    aria-expanded="false" aria-controls="accor_nestingExamplecollapse3">
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <h6 class="text-primary" data-bs-toggle="collapse"
                                            data-bs-target="#collapseblock" aria-expanded="true"
