                                        ...
                                        <div class="card-body p-sm-5 m-lg-4">
                                            ...
                                            <div class="p-2 mt-5">
                                                <form class="needs-validation" novalidate action="index.php">
                                                    ...
                                                    <div class="mb-4">
                                                        <p class="mb-0 fs-sm text-muted fst-italic">By registering you agree to the Vixon <a href="pages-term-conditions.php" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                                    </div>
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <a href="auth-signin.php" class="text-secondary text-decoration-underline"> Sign In </a>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
                                </div>
